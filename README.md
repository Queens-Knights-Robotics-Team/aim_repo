[![pipeline status](https://gitlab.com/aruw/controls/aim_bot_repo/badges/develop/pipeline.svg)](https://gitlab.com/aruw/controls/aim_bot_repo/-/commits/develop)
...
```
cd my-amazing-project/aim_bot_repo-project
pipenv shell
# Build for hardware
scons build
# Run automated tests
...
1. Make sure you have VSCode opened in the folder `aim_bot_repo` (**not
   `aim_bot_repo-project`**)
...
1. Open the folder `aruw-aim_bot_repo-project` in VSCode. Hit the debug tab on the left side or type
...
`/aim_bot_repo-project/robot-type/robot_type.hpp` and change the macro defined in this file.
...
The below commands require that your working directory is `/aim_bot_repo-project` (where the
